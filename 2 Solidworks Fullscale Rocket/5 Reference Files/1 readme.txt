...
1 Upper Section
This will contain three subfolders: 1 Nose Cone, 2 Payload Airframe, 3 Payload bay. It 
will also contain an assembly file of the assembled upper section in the main directory. 

1 Upper Section > 1 Nose Cone
This will contain the nose cone as a standalone part.

1 Upper Section > 2 Payload Airframe
This will contain the payload airframe tube. It will be a standalone part

1 Upper Section > 3 Payload Bay
This will include the payload bay coupler, switchband, bulkheads, and all associated 
payload hardware. It will contain an assembly of the payload bay.
...
3 Lower Section
This will contain 4 subfolders: 1 Lower Airframe, 2 ATS Bay, 3 Motor Retention System, 
and 4 Fins. It will also contain an assembly file of the assembled lower section in the 
main directory.

3 Lower Section > 1 Lower Airframe
This will contain the lower airframe tube. It will be a standalone part.

3 Lower Section > 2 ATS Bay
This will contain the ATS coupler, ATS switchband, and all ATS electronics/hardware.
It will contain a subassembly of all these parts

3 Lower Section > 3 Motor Retention System
...
3 Lower Section > 4 Fins
This will contain the fins as a standalone part.


4 Miscellaneous
This will contain miscellaneous CAD files relating to the full scale rocket
